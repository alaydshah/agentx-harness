...
class CreditCounter:
    ...
    @property
    def all_admitted_root_turns_sent(self) -> bool:
        """Whether every turn of every admitted depth-zero session was issued."""
        return self._root_requests_sent >= self._total_session_turns
